...
set CP=%JG%\classes\;%JG%\conf\;%LIB%\commons-logging.jar\;%LIB%\concurrent.jar\;%LIB%\jmxri.jar\;%LIB%\log4j.jar\;%JG%\keystore
...
set FLAGS=-Djava.net.preferIPv4Stack=true -Djgroups.bind_addr=192.168.5.2 -Djgroups.tcpping.initial_hosts=127.0.0.1[7800]
