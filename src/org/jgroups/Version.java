 ...
 *
 * @author Bela Ban
 * @version $Id: Version.java,v 1.90 2010/01/25 16:46:56 belaban Exp $
...
public class Version {
    ...
    public static final String description="2.9.0.Beta1";

    public static final short version=encode(major, minor, micro);
    public static final String string_version=print(version);
    public static final String cvs="$Id: Version.java,v 1.90 2010/01/25 16:46:56 belaban Exp $";
