 ...
 *
 * @author Bela Ban
 * @version $Id: Version.java,v 1.42.2.12 2009/05/11 22:41:02 rachmatowicz Exp $
...
public class Version {
    ...
    public static final String description="2.4.6.GA";

    public static final short version=encode(major, minor, micro);
    public static final String string_version=print(version);
    public static final String cvs="$Id: Version.java,v 1.42.2.12 2009/05/11 22:41:02 rachmatowicz Exp $";
