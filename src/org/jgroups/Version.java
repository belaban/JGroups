 ...
 *
 * @author Bela Ban
 * @version $Id: Version.java,v 1.59.2.20 2009/07/31 13:00:24 belaban Exp $
...
public class Version {
    ...
    public static final short micro = 12;
    public static final String description="2.6.12.Beta1";

    public static final short version=encode(major, minor, micro);
    public static final String string_version=print(version);
    public static final String cvs="$Id: Version.java,v 1.59.2.20 2009/07/31 13:00:24 belaban Exp $";
