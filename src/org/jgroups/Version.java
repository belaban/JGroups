 ...
 *
 * @author Bela Ban
 * @version $Id: Version.java,v 1.59.2.11 2008/10/29 16:26:18 vlada Exp $
...
public class Version {
    ...
    public static final String description="2.6.6.CR1";

    public static final short version=encode(major, minor, micro);
    public static final String string_version=print(version);
    public static final String cvs="$Id: Version.java,v 1.59.2.11 2008/10/29 16:26:18 vlada Exp $";
