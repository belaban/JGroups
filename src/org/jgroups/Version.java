 ...
 *
 * @author Bela Ban
 * @version $Id: Version.java,v 1.59.2.15 2009/02/09 17:43:08 vlada Exp $
...
public class Version {
    ...
    public static final String description="2.6.8.CR1";

    public static final short version=encode(major, minor, micro);
    public static final String string_version=print(version);
    public static final String cvs="$Id: Version.java,v 1.59.2.15 2009/02/09 17:43:08 vlada Exp $";
