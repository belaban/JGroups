...
public class Util {
   ...
   public static byte[] createAuthenticationDigest(String passcode, long t1, double q1) throws IOException,
    ...
    public static byte[] encode(long num) {
       return NumberEncoding.encode(num);
    }

    @Deprecated
    static protected byte getByteAt(long num, int index) {
        return NumberEncoding.getByteAt(num, index);
    }

    @Deprecated
    public static long decode(byte[] buf) {
       return NumberEncoding.decode(buf);
    }

    @Deprecated
    public static void writeLong(final long num, final DataOutput out) throws Exception {
        NumberEncoding.writeLong(num, out);
    }

    @Deprecated
    public static long readLong(final DataInput in) throws Exception {
        return NumberEncoding.readLong(in);
    }
    ...
    static long makeLong(byte[] buf, int offset, int len) {
       return NumberEncoding.makeLong(buf, offset, len);
    }

    @Deprecated
    public static byte[] encodeLongSequence(long highest_delivered, long highest_received) {
        return NumberEncoding.encodeLongSequence(highest_delivered, highest_received);
    }

    @Deprecated
    private static byte numberOfBytesRequiredForLong(long number) {
       return NumberEncoding.numberOfBytesRequiredForLong(number);
    }
    ...
    public static byte size(long number) {
       return NumberEncoding.size(number);
    }

    @Deprecated
    public static byte size(long hd, long hr) {
        return NumberEncoding.size(hd, hr);
    }
