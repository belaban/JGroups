...
//	private List<Integer> oneRoundFToL = new ArrayList<Integer>();
...
//				//outFile.println("One way Latency (FToL): " +(double)(FtOLOneR)/1000000);
...
//		log.info("First element"+ data.get(0));
//		log.info("Second element"+ data.get(1));
//
//
//		long sum=0;
//		double avg=0;
