...
public class TCP extends BasicTCP {
    ...
    public void start() throws Exception {
        srv=new TcpServer(getThreadFactory(), getSocketFactory(), bind_addr, bind_port, bind_port+port_range, external_addr, external_port)
          .setLogAcceptError(log_accept_error);
        srv.receiver(this)
