...
public class S3_PING extends FILE_PING {
    ...
    public boolean setProperties(Properties props) {
        ...
        str=props.getProperty("access_key");
        if(str != null) {
            access_key=str;
            props.remove("access_key");
        }

        str=props.getProperty("secret_access_key");
        if(str != null) {
...
class ListBucketResponse extends Response {
...
class ListAllMyBucketsResponse extends Response {
    /**
