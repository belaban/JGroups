...
import org.jgroups.util.Util;
    ...
    public class ZabCoinTossingHeader extends Header {
...
//         public static final byte RESPONCETEMP = 16;
        ...
        public ZabCoinTossingHeader() {
        }

        public ZabCoinTossingHeader(byte type) {
            this.type=type;
        }
        public ZabCoinTossingHeader(byte type, MessageId id) {
            this.type=type;
            this.messageId=id;
        }

        public ZabCoinTossingHeader(byte type, long seqno) {
            this(type);
            this.seqno=seqno;
        }
        public ZabCoinTossingHeader(byte type, long seqno, MessageId messageId) {
            this(type);
            this.seqno=seqno;
