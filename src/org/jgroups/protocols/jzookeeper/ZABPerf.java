 ...
 * @since 3.1
 */
public class ZABPerf extends ReceiverAdapter {
    ...
    /** Maintains stats per sender, will be sent to ZABperf originator when all messages have been received */
    ...
    protected static final short                  ID=ClassConfigurator.getProtocolId(ZABPerf.class);
   ...
   protected static InputStream findFile(String filename) {
        ...
        return Util.getResourceAsStream(name, ZABPerf.class);
    }
...
//        }
        ...
        Thread thread=new Thread() {
            public void run() {
                try {
                    ...
                    channel=ch;
                    channel.setName(name);
                    channel.setReceiver(ZABPerf.this);
    ...
    protected void sendMessages() {
        ...
        for(int i=0; i < num_threads; i++) {
            senders[i]=new Sender(barrier, num_msgs_sent, actually_sent, seqno, data);
    ...
    protected class Sender extends Thread {
        ...
        protected Sender(CyclicBarrier barrier, AtomicInteger num_msgs_sent, AtomicInteger actually_sent,
                         AtomicLong seqno, String payload) {
    ...
    public static void main(String[] args) {
        ...
        final ZABPerf test=new ZABPerf();
        try {
