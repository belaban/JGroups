...
public class RELAY2 extends Protocol {
    ...
    @Property(description="Time (in ms) during which identical errors about no route to host will be suppressed. " +
      "0 disables this (every error will be logged).")
    ...
    protected void sendSiteUnreachableTo(Address src, String target_site) {
        ...
        Message msg=new Message(src).setFlag(Message.Flag.OOB, Message.Flag.INTERNAL)
