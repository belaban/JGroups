// $Id: ReplicatedTreeDemo.java,v 1.1.1.1 2003/09/09 01:24:09 belaban Exp $
...
public class ReplicatedTreeDemo {
	...
	public static void main(String args[]) {
		...
		demo=new ReplicatedTreeView(tree, "<null address>");	    
	...
	try {
	    ...
	    demo=new ReplicatedTreeView(tree, tree.getLocalAddress());
	    // demo.setVisible(true);
