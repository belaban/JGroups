// $Id: MessageDispatcher.java,v 1.15 2004/04/29 13:46:24 yaron-r Exp $
...
//                    break;
        ...
        private void handleUp(Event evt) {
            if (null != corr) {
                corr.receive(evt);
            } else if (log.isErrorEnabled()) { //Something is seriously wrong, correlator should not be null since latch is not locked!
