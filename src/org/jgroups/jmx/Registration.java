...
public class Registration {
    ...
    public static void register(Object obj, MBeanServer server) throws MBeanRegistrationException, MalformedObjectNameException{
    ...
    private static void internalRegister(Object obj, MBeanServer server, String name) throws MalformedObjectNameException, MBeanRegistrationException {
    	...
    	if(!obj.getClass().isAnnotationPresent(MBean.class)){
        	throw new MBeanRegistrationException(null,"Instance " + obj + " of a class " + obj.getClass() + " is not annotated with the @MBean annotation");
        }
    ...
    private static ObjectName getObjectName(Object obj, String name) throws MalformedObjectNameException {     
        ...
        if (name != null && name.length() > 0) {
            ...
            throw new MalformedObjectNameException("Instance " + obj + " of a class " + obj.getClass() + " does not have a valid object name");
        }                   
    }
}
