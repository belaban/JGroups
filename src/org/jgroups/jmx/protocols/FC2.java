...
/**
 * @author Bela Ban
 * @version $Id: FC2.java,v 1.1.2.1 2007/04/18 05:18:09 bstansberry Exp $
 */
public class FC2 extends Protocol implements FC2MBean {
    org.jgroups.protocols.FC2 p;

    public FC2() {
    }

    public FC2(org.jgroups.stack.Protocol p) {
        super(p);
        this.p=(org.jgroups.protocols.FC2)p;
    }
