 ...
 * 
 */
public class ResourceDMBeanOld implements DynamicMBean {
    ...
    private final Log log=LogFactory.getLog(ResourceDMBeanOld.class);
    ...
    public ResourceDMBeanOld(Object instance) {
        if(instance == null)
    ...
    private void findDescription() {
        ...
        if(mbean != null && mbean.description() != null && !mbean.description().trim().isEmpty()) {
            description=mbean.description();
            MBeanAttributeInfo info=new MBeanAttributeInfo(ResourceDMBeanOld.MBEAN_DESCRITION,
                                                           "java.lang.String",
                                                           "MBean description",
                                                           true,
                                                           false,
                                                           false);
            try {
                atts.put(ResourceDMBeanOld.MBEAN_DESCRITION,
    ...
    private Attribute getNamedAttribute(String name) {
        ...
        if(name.equals(ResourceDMBeanOld.MBEAN_DESCRITION)) {
            result=new Attribute(ResourceDMBeanOld.MBEAN_DESCRITION, this.description);
        }
        else {
