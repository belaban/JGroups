// $Id: LogicalAddress.java,v 1.1 2003/12/23 18:03:07 belaban Exp $
...
public class LogicalAddress implements Address {
    ...
    public LogicalAddress(String i, int p) {
        try {
    ...
    public LogicalAddress(InetAddress i, int p) {
        ip_addr=i; port=p;
    }



    public LogicalAddress(int port) {
        try {
    ...
    public Object clone() throws CloneNotSupportedException {
        LogicalAddress ret=new LogicalAddress(ip_addr, port);
        if(additional_data != null) {
    ...
    protected static InetAddress getIpAddress(byte[] addr) {
        try {
            ...
            if(result == null) {
                result = InetAddress.getByName(addressToString(addr));
