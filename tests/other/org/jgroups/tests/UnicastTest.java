// $Id: UnicastTest.java,v 1.1.1.1 2003/09/09 01:24:13 belaban Exp $
...
public class UnicastTest implements Runnable {
	...
	StartData(long num_values) {this.num_values=num_values;}
	...
	while(true) {
	    System.out.print("[1] Send msgs [2] Print view [q] Quit "); System.out.flush();
	    c=System.in.read();
	    switch(c) {
	    case -1:
		break;
	...
	try {
	    System.out.print("Number of messages to send: "); System.out.flush();
	    System.in.skip(System.in.available());
