// $Id: RpcDispatcherBlocking.java,v 1.1.1.1 2003/09/09 01:24:13 belaban Exp $
...
public class RpcDispatcherBlocking implements MembershipListener {
    ...
    public void start() throws Exception {
        ...
        channel=new JChannel(null); // default props
    ...
    RspList sendGroupRpc() throws Exception {
        return disp.callRemoteMethods(null, "print", new Integer(i++), GroupRequest.GET_ALL, 0);
    }
