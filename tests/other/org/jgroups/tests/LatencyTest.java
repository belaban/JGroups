...
/**
 * @author Bela Ban
 * @version $Id: LatencyTest.java,v 1.1 2007/05/04 11:24:36 belaban Exp $
 */
public class LatencyTest {
    InetAddress GROUP=null;
    int PORT=7500;

    private void start(boolean sender) throws Exception {
    ...
    public static void main(String[] args) throws Exception {
        ...
        new LatencyTest().start(sender);
    }

    private static void help() {
        System.out.println("LatencyTest [-sender]");
    }
