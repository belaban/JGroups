// $Id: AckMcastSenderWindowTest.java,v 1.1.1.1 2003/09/09 01:24:12 belaban Exp $
...
public class AckMcastSenderWindowTest extends TestCase {
	...
	new IpAddress("localhost", 5000), 
	new IpAddress("localhost", 5001), 
	new IpAddress("localhost", 5002)
	    };
