// $Id: ChannelMono.java,v 1.5 2004/07/05 14:15:04 belaban Exp $
...
public class ChannelMono extends TestCase
{
    ...
    static Logger logger = Logger.getLogger(ChannelMono.class);
    ...
    /** 
     * Multiple threads add one element, multiple threads read them all.
     */
    ...
    {
        String[] testCaseName = { ChannelMono.class.getName()};
