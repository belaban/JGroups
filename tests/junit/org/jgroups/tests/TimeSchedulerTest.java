// $Id: TimeSchedulerTest.java,v 1.1.1.1 2003/09/09 01:24:13 belaban Exp $
...
public class TimeSchedulerTest extends TestCase {
    ...
    public TimeSchedulerTest(String name) { super(name); }
