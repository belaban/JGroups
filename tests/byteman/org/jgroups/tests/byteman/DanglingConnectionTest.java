...
public class DanglingConnectionTest extends BMNGRunner {
    ...
    @BMScript(dir = "conf/scripts/DanglingConnectionTest", value = "testDanglingConnectionTest_DanglingAfterClose")
    public void testDanglingConnectionTest_DanglingAfterCloseWithEnabledSuspects(Boolean enableSuspects) throws Throwable {
