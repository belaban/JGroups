...
*/
    ...
    protected static void addAndGet(Table<Integer> table, long seqno, int value) {
        boolean added=table.add(seqno,value);
        assert added;
        Integer val=table.get(seqno);
        assert val != null && val == value;
    }
